  ...
  "mcpServers": {
    "project-memory-mcp": {
      ...
      "env": {
        ...
        "PROJECT_MEMORY_INTERFACE": "native"
      }
    }
  }
}
...
Make sure `PROJECT_MEMORY_INTERFACE=opencode` is available in the MCP environment.
...
Set `PROJECT_MEMORY_INTERFACE=claude-code` for that client.
